...
namespace SOF.Scripts.UI
{
    public class UIBase : MonoBehaviour
    {
        ...
        public static void BindEventUI(GameObject obj, Action action = null, Action<BaseEventData> dragAction = null, Define.UIEvent type = Define.UIEvent.Click)
        {
        ...
        internal static void BindEvent(GameObject obj, Action action, Action<BaseEventData> dragAction, Define.UIEvent type)
        {
